...
def draw_center_dashed_line(num_dashes, color):
    ...
    while x_off < WINDOW_WIDTH:
        pygame.draw.line(WINDOW, color, (x_off, SCREEN_MIDDLE[1]), (x_off + division_width, SCREEN_MIDDLE[1]))
...
def main () :
  ...
  while True:
    ...
    draw_text(str(ball.score[PADDLE_BOTTOM]), [0, 0, 0], (SCREEN_MIDDLE[0], SCREEN_MIDDLE[1] + SCORE_OFFSET))

    draw_text(str(ball.score[PADDLE_TOP]), [0, 0, 0], (SCREEN_MIDDLE[0], SCREEN_MIDDLE[1] - SCORE_OFFSET))
